...
begin
  ...
  StringList.SaveToFile(ChangeFileExt(ParamStr(0), '.ini'));
  ...
  StringList.SaveToFile(IncludeTrailingPathDelimiter(ExtractFilePath(ParamStr(0))) + FILE_NAME);
end;

procedure TIniUtilTests.TearDown;
begin
  DeleteFile(ChangeFileExt(ParamStr(0), '.ini'));
  DeleteFile(IncludeTrailingPathDelimiter(ExtractFilePath(ParamStr(0))) + FILE_NAME);
end;
...
var
  ExpectedValue, ActualValue: String;
begin
  TIniUtil.FileName := IncludeTrailingPathDelimiter(ExtractFilePath(ParamStr(0))) + FILE_NAME;
